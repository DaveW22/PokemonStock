...
export default function Hero() {
  return (
    <motion.section
      ...
      className="relative overflow-hidden rounded-[24px] border border-white/10 bg-[radial-gradient(circle_at_top_left,_rgba(129,140,248,0.18),_transparent_35%),linear-gradient(135deg,rgba(15,14,39,0.98),rgba(8,8,23,0.96))] p-4 shadow-2xl shadow-black/30 md:rounded-[34px] md:p-8"
    >
      ...
      <div className="relative grid gap-4 md:gap-8 xl:grid-cols-[1.2fr_0.8fr]">
        <div>
          ...
          <h1 className="max-w-2xl text-2xl font-semibold tracking-tight text-white md:text-5xl">
            Pokemon <span className="text-violet-400">Stock Watcher</span>
          </h1>
          <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-300 md:mt-4 md:text-lg md:leading-7">
